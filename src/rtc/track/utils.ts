import { cloneDeep, isSafari, sleep } from "../utils";
import type { FFCCreateLocalTracksOptions, FFCAudioCaptureOptions, FFCVideoCaptureOptions, FFCScreenShareCaptureOptions, FFCVideoCodec } from "./options";
import type { FFCTrackProcessor, FFCAudioProcessorOptions, FFCVideoProcessorOptions } from "./processor/types";
import { FFCTrack } from "./track";
import type { FFCTrackPublication } from "./track-publication";
import type { FFCAudioTrack } from "./types";
import type { FFCTrackPublishedResponse } from "../protocol";
...
export function extractProcessorsFromOptions(options: FFCCreateLocalTracksOptions) {
  ...
  let audioProcessor: FFCTrackProcessor<FFCTrack.Kind.Audio, FFCAudioProcessorOptions> | undefined;
  let videoProcessor: FFCTrackProcessor<FFCTrack.Kind.Video, FFCVideoProcessorOptions> | undefined;
